...
(function() {
    ...
    function getLabelsButton() {
        return $('.add-new-dialog.add-new-story button.add-labels, .story-container #story-dialog-add-label-dropdown');
    }
    ...
    $("body").keypress(function(e) {
        ...
        // console.log(e);
        if (e.key === 'e') {
            $('.story-container .description-container button.edit-description:visible').click();
        } else if (e.key === 't') {
