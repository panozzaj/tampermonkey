...
(function() {
    ...
    const addCopyButton = () => {
        ...
        numberElement = document.querySelector('.gh-header-title .f1-light.color-fg-muted');
        ...
        if (!titleElement || !numberElement) {
            ...
            numberElement = document.querySelector('a[data-hovercard-url*="/issues/"]') ||
        ...
        `;
        button.addEventListener('mouseenter', () => { button.style.backgroundColor = 'var(--bgColor-neutral-muted, #f6f8fa)'; button.style.borderColor = 'var(--borderColor-neutral-muted, #d0d7de)'; });
        button.addEventListener('mouseleave', () => { button.style.backgroundColor = 'transparent'; button.style.borderColor = 'transparent'; });
